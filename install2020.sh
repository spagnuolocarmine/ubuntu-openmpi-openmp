...
ssh-keygen -t rsa -b 4096  -f "pcpc-key" -q -P ""

cp pcpc-key /home/pcpc/.ssh/id_rsa
cp pcpc-key.pub /home/pcpc/.ssh/id_rsa.pub
cat pcpc-key.pub >> /home/pcpc/.ssh/authorized_keys
